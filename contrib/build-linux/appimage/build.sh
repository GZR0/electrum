...
(
    ...
    for i in ./locale/*; do
        dir="$PROJECT_ROOT/electrum_gzro/$i/LC_MESSAGES"
        mkdir -p $dir
...
cp "$PROJECT_ROOT/electrum-gzro.desktop" "$APPDIR/electrum-gzro.desktop"
cp "$PROJECT_ROOT/electrum_gzro/gui/icons/electrum-gzro.png" "$APPDIR/electrum-gzro.png"
