...
ICONS_FILE=PYPKG + '/gui/icons/electrum-gzro.icns'
...
a = Analysis([electrum+ MAIN_SCRIPT,
              electrum+'electrum_gzro/gui/qt/main_window.py',
              electrum+'electrum_gzro/gui/text.py',
              electrum+'electrum_gzro/util.py',
              electrum+'electrum_gzro/wallet.py',
              electrum+'electrum_gzro/simple_config.py',
              electrum+'electrum_gzro/bitcoin.py',
              electrum+'electrum_gzro/dnssec.py',
              electrum+'electrum_gzro/commands.py',
              electrum+'electrum_gzro/plugins/cosigner_pool/qt.py',
              electrum+'electrum_gzro/plugins/email_requests/qt.py',
              electrum+'electrum_gzro/plugins/trezor/qt.py',
              electrum+'electrum_gzro/plugins/safe_t/client.py',
              electrum+'electrum_gzro/plugins/safe_t/qt.py',
              electrum+'electrum_gzro/plugins/keepkey/qt.py',
              electrum+'electrum_gzro/plugins/ledger/qt.py',
              electrum+'electrum_gzro/plugins/coldcard/qt.py',
              ],
             binaries=binaries,
             datas=datas,
