...
from electrum_gzro.wallet import Wallet, create_new_wallet
from electrum_gzro.commands import Commands


config = SimpleConfig({"testnet": True})  # to use ~/.electrum-gzro/testnet as datadir
