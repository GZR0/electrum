...
from electrum_gzro import WalletStorage, Wallet
...
from electrum_gzro.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid Gravity address'))
            return
        try:
