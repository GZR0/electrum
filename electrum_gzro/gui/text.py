...
from electrum_gzro.util import format_satoshis
from electrum_gzro.bitcoin import is_address, COIN, TYPE_ADDRESS
from electrum_gzro.transaction import TxOutput
from electrum_gzro.wallet import Wallet
from electrum_gzro.storage import WalletStorage
from electrum_gzro.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_gzro.interface import deserialize_server
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_gzro.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
