...
from electrum_gzro.bitcoin import TYPE_ADDRESS
from electrum_gzro.storage import WalletStorage, StorageReadWriteError
from electrum_gzro.wallet import Wallet, InternalAddressCorruption
from electrum_gzro.util import profiler, InvalidPassword, send_exception_to_crash_reporter
from electrum_gzro.plugin import run_hook
from electrum_gzro.util import format_satoshis, format_satoshis_plain, format_fee_satoshis
from electrum_gzro.util import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
from electrum_gzro import blockchain
from electrum_gzro.network import Network, TxBroadcastError, BestEffortRequestFailed
from .i18n import _
...
Factory.register('TabbedCarousel', module='electrum_gzro.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_gzro/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_gzro/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_gzro/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_gzro/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrum_gzro.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
if TYPE_CHECKING:
    ...
    from electrum_gzro.simple_config import SimpleConfig
    from electrum_gzro.wallet import Abstract_Wallet
    from electrum_gzro.plugin import Plugins
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_gzro import constants
    ...
    def build(self):
        return Builder.load_file('electrum_gzro/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for gravity: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_gzro/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_gzro.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_gzro.gui.kivy.uix.qrcodewidget')
        ...
        self.icon = "electrum_gzro/gui/icons/electrum-gzro.png"
    ...
    def get_max_amount(self):
        from electrum_gzro.transaction import TxOutput
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_gzro/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_gzro/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_gzro/gui/kivy/theming/light/card'
        else:
