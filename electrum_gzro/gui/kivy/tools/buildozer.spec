...
source.exclude_dirs = bin, build, dist, contrib,
    ...
    electrum_gzro/gui/kivy/tools,
    electrum_gzro/gui/kivy/theming/light,
...
version.filename = %(source.dir)s/electrum_gzro/version.py
...
presplash.filename = %(source.dir)s/electrum_gzro/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_gzro/gui/icons/electrum_launcher.png
...
android.add_src = electrum_gzro/gui/kivy/data/java-classes/
...
android.manifest.intent_filters = electrum_gzro/gui/kivy/tools/bitcoin_intent.xml
