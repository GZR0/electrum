...
from electrum_gzro.util import InvalidPassword
from electrum_gzro.address_synchronizer import TX_HEIGHT_LOCAL
from electrum_gzro.wallet import CannotBumpFee
    ...
    BoxLayout:
        ...
        BoxLayout:
            ...
            IconButton:
                size_hint: 0.5, None
                height: '48dp'
                icon: 'atlas://electrum_gzro/gui/kivy/theming/light/qrcode'
