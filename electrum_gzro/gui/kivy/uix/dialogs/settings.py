...
from electrum_gzro.util import base_units_list
from electrum_gzro.i18n import languages
from electrum_gzro.gui.kivy.i18n import _
from electrum_gzro.plugin import run_hook
from electrum_gzro import coinchooser
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for Gravity amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def proxy_dialog(self, item, dt):
        ...
        if self._proxy_dialog is None:
            ...
            popup = Builder.load_file('electrum_gzro/gui/kivy/uix/ui_screens/proxy.kv')
