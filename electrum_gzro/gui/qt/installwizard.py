...
from electrum_gzro.wallet import Wallet, Abstract_Wallet
from electrum_gzro.storage import WalletStorage, StorageReadWriteError
from electrum_gzro.util import UserCancelled, InvalidPassword, WalletFileException
from electrum_gzro.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
from electrum_gzro.plugin import run_hook, Plugins
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins'):
        ...
        self.set_icon('electrum-gzro.png')
        self.show()
        self.raise_()
